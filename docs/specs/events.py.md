...
> **注(2026-09-14)**:"**57** 个事件负载"为**基线引用**(PARAMETER-ANCHOR 基线 57),**保留不改**;后续版本已演进至现行 **`EVENT_TYPES = 74`**(72 payload 模型),见 `docs/EVENT-SCHEMA.md` §3 与 `docs/baseline/`。本文件余下"57"同属基线语境。
